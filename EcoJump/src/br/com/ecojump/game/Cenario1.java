...
public class Cenario1 {
    ...
    private void drawGameOver() {
        Sprite gameOverImage = new Sprite("src//recursos//imagens//gameover.png");
    ...
    private void drawVictory() {
        Sprite victoryImage = new Sprite("src//recursos//imagens//vitoria.png");
